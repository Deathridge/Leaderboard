...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ../../stylesheets/main.scss */ 166);
	
	var Leader = _react2.default.createClass({
		displayName: 'Leader',
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'avatar' },
					_react2.default.createElement('img', { className: 'avatar', src: this.props.img })
				),
				_react2.default.createElement(
					'div',
					{ className: 'username' },
	...
	var Leaders = _react2.default.createClass({
		displayName: 'Leaders',
	
		render: function render() {
			var leaderNodes = this.props.data.map(function (leader) {
				return _react2.default.createElement(Leader, { username: leader.username, recent: leader.recent, alltime: leader.alltime, img: leader.img, key: leader.username });
			});
	...
	var LeaderList = _react2.default.createClass({
		...
		recentClick: function recentClick() {
			var newData = this.state.data.sort(function (a, b) {
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'button',
						{ className: 'button', onClick: this.recentClick },
						'Recent'
					),
					_react2.default.createElement(
						'button',
						{ className: 'button', onClick: this.allClick },
						'All'
					)
				),
				_react2.default.createElement(Leaders, { data: this.state.data })
			);
		}
	});
	
	(0, _reactDom.render)(_react2.default.createElement(LeaderList, { source: 'https://fcctop100.herokuapp.com/api/fccusers/top/recent' }), document.getElementById('app'));
